 ...
 */
final class Version20220607183329 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE film_sessions (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', date_time_start DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', tickets_count INT NOT NULL, date_time_end DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', film_film_name VARCHAR(255) NOT NULL, film_film_length INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
